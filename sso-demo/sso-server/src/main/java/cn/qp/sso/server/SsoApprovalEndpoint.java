...
/**
 * 覆盖掉{@link WhitelabelApprovalEndpoint}的类，使client认证时不需要在表单进行登录
 * RestController注解会覆盖@FrameworkEndpoint注解的路径
 *
 * @author Baozi
 *
 */
...
public class SsoApprovalEndpoint {
	...
	// 修改这部分代码 <div style='display:none;'>，当跳转到授权时用户看不到任何页面
    // <script>document.getElementById('confirmationForm').submit()</script> 直接提交表单
